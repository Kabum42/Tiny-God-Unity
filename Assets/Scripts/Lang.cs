...
public static class Lang {
	...
	public static void Start () {
		...
		ENGLISH_WORDS[FACTORY_UPGRADE_2] = "Chain production";
		ENGLISH_WORDS[FACTORY_UPGRADE_2_JOKE] = "Literally";
		ENGLISH_WORDS[FACTORY_UPGRADE_3] = "Tiny hands";
		ENGLISH_WORDS[FACTORY_UPGRADE_3_JOKE] = "Tiny workers to manage even the tiniest details";
		ENGLISH_WORDS[FACTORY_UPGRADE_4] = "Steam engines";
		ENGLISH_WORDS[FACTORY_UPGRADE_4_JOKE] = "Increased production at the expense of a few accidents";
		ENGLISH_WORDS[FACTORY_UPGRADE_5] = "Fire drill";
		ENGLISH_WORDS[FACTORY_UPGRADE_5_JOKE] = "Dead employees will be fired";
		ENGLISH_WORDS[FACTORY_UPGRADE_6] = "Scab Monkeys";
		ENGLISH_WORDS[FACTORY_UPGRADE_6_JOKE] = "They demand a lot of bananas, but do not demand any right";
		ENGLISH_WORDS[FACTORY_UPGRADE_7] = "Acid Rivers";
		ENGLISH_WORDS[FACTORY_UPGRADE_7_JOKE] = "Catching fish bare-hands it’s easy when they float face up";
		...
		ENGLISH_WORDS[LABORATORY_UPGRADE_3] = "Love fundamental particle";
		ENGLISH_WORDS[LABORATORY_UPGRADE_3_JOKE] = "The model is perfect, but reality doesn’t fit well in it";
		...
		ENGLISH_WORDS[LABORATORY_UPGRADE_5] = "Quantum love";
		ENGLISH_WORDS[LABORATORY_UPGRADE_5_JOKE] = "Entangled hearts";
		ENGLISH_WORDS[LABORATORY_UPGRADE_6] = "Robo-maid";
		ENGLISH_WORDS[LABORATORY_UPGRADE_6_JOKE] = "Scientists are very pleased";
		ENGLISH_WORDS[LABORATORY_UPGRADE_7] = "LoveOS";
		ENGLISH_WORDS[LABORATORY_UPGRADE_7_JOKE] = "The answer to your question is 69";
		...
		ENGLISH_WORDS[SHOP_UPGRADE_2] = "Disposable love";
		ENGLISH_WORDS[SHOP_UPGRADE_2_JOKE] = "Piles of rubbish as far as the eye can see";
		ENGLISH_WORDS[SHOP_UPGRADE_3] = "Invasive product placement";
		ENGLISH_WORDS[SHOP_UPGRADE_3_JOKE] = "Enjoy incredible ads while you’re dreaming";
		ENGLISH_WORDS[SHOP_UPGRADE_4] = "Loveh*";
		ENGLISH_WORDS[SHOP_UPGRADE_4_JOKE] = "Almost* like the original";
		ENGLISH_WORDS[SHOP_UPGRADE_5] = "Brand new love";
		ENGLISH_WORDS[SHOP_UPGRADE_5_JOKE] = "Totally different from the previous one";
		ENGLISH_WORDS[SHOP_UPGRADE_6] = "Make up new festivity";
		ENGLISH_WORDS[SHOP_UPGRADE_6_JOKE] = "Consume more, you bastards";
		ENGLISH_WORDS[SHOP_UPGRADE_7] = "LoveCard®";
		ENGLISH_WORDS[SHOP_UPGRADE_7_JOKE] = "There are things that love can’t buy, for everything else: LoveCard®";
		...
		ENGLISH_WORDS[SPACESHIP_UPGRADE_2] = "Space junk";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_2_JOKE] = "Although you can throw it far away it’s not gonna disappear";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_3] = "International Space Station";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_3_JOKE] = "Zero gravity opens up new possibilities, we must update the Holy Book of Love";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_4] = "Cosmic jet";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_4_JOKE] = "Shake before use";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_5] = "Open up pink hole";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_5_JOKE] = "Crossing it can cause a tear in the space-time";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_6] = "Close Encounters of the Third Kind";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_6_JOKE] = "They are a bit stupid, but we must learn to love them - Signed: The Aliens";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_7] = "Galactic Empire";
		ENGLISH_WORDS[SPACESHIP_UPGRADE_7_JOKE] = "May the love be with you";
		...
		SPANISH_WORDS[FACTORY_UPGRADE_2] = "Producción en cadena";
		SPANISH_WORDS[FACTORY_UPGRADE_2_JOKE] = "Literalmente";
		SPANISH_WORDS[FACTORY_UPGRADE_3] = "Manos pequeñas";
		SPANISH_WORDS[FACTORY_UPGRADE_3_JOKE] = "Pequeños trabajadores para prestar atención a los más pequeños detalles";
		SPANISH_WORDS[FACTORY_UPGRADE_4] = "Máquinas a vapor";
		SPANISH_WORDS[FACTORY_UPGRADE_4_JOKE] = "Aumentan la producción a costa de unos pocos accidentes";
		SPANISH_WORDS[FACTORY_UPGRADE_5] = "Simulacro de incendio";
		SPANISH_WORDS[FACTORY_UPGRADE_5_JOKE] = "Los empleados fallecidos serán despedidos";
		SPANISH_WORDS[FACTORY_UPGRADE_6] = "Monos esquiroles";
		SPANISH_WORDS[FACTORY_UPGRADE_6_JOKE] = "Consumen mucho plátano, pero no reclaman ningún derecho";
		SPANISH_WORDS[FACTORY_UPGRADE_7] = "Ríos ácidos";
		SPANISH_WORDS[FACTORY_UPGRADE_7_JOKE] = "Cazar peces con las manos es fácil cuando flotan boca arriba";
		...
		SPANISH_WORDS[LABORATORY_UPGRADE_3] = "Partícula fundamental del amor";
		SPANISH_WORDS[LABORATORY_UPGRADE_3_JOKE] = "El modelo es perfecto, pero la realidad no se ajusta bien a él";
		...
		SPANISH_WORDS[LABORATORY_UPGRADE_5] = "Amor cuántico";
		SPANISH_WORDS[LABORATORY_UPGRADE_5_JOKE] = "Corazones entrelezados";
		SPANISH_WORDS[LABORATORY_UPGRADE_6] = "Robo-sirvienta";
		SPANISH_WORDS[LABORATORY_UPGRADE_6_JOKE] = "Los científicos están encantados";
		SPANISH_WORDS[LABORATORY_UPGRADE_7] = "LoveOS";
		SPANISH_WORDS[LABORATORY_UPGRADE_7_JOKE] = "La respuesta a tu pregunta es 69";
		...
		SPANISH_WORDS[SHOP_UPGRADE_2] = "Amor de usar y tirar";
		SPANISH_WORDS[SHOP_UPGRADE_2_JOKE] = "Montañas de basura hasta donde alcanza la vista";
		SPANISH_WORDS[SHOP_UPGRADE_3] = "Anuncios invasivos";
		SPANISH_WORDS[SHOP_UPGRADE_3_JOKE] = "Disfruta de increíbles anuncios mientras sueñas";
		SPANISH_WORDS[SHOP_UPGRADE_4] = "Hamor*";
		SPANISH_WORDS[SHOP_UPGRADE_4_JOKE] = "Casi* como el original";
		SPANISH_WORDS[SHOP_UPGRADE_5] = "Amor nuevísimo";
		SPANISH_WORDS[SHOP_UPGRADE_5_JOKE] = "Totalmente diferente del anterior";
		SPANISH_WORDS[SHOP_UPGRADE_6] = "Inventar nueva festividad";
		SPANISH_WORDS[SHOP_UPGRADE_6_JOKE] = "Consumid más, malditos";
		SPANISH_WORDS[SHOP_UPGRADE_7] = "LoveCard®";
		SPANISH_WORDS[SHOP_UPGRADE_7_JOKE] = "Hay cosas que el amor no puede comprar, para todo lo demás: LoveCard®";
		...
		SPANISH_WORDS[SPACESHIP_UPGRADE_2] = "Basura espacial";
		SPANISH_WORDS[SPACESHIP_UPGRADE_2_JOKE] = "Por muy alto que la tires no va a desaparecer";
		SPANISH_WORDS[SPACESHIP_UPGRADE_3] = "Estación Espacial Internacional";
		SPANISH_WORDS[SPACESHIP_UPGRADE_3_JOKE] = "La gravedad cero abre nuevas posibilidades, hay que actualizar el Libro Sagrado del Amor";
		SPANISH_WORDS[SPACESHIP_UPGRADE_4] = "Chorro cósmico";
		SPANISH_WORDS[SPACESHIP_UPGRADE_4_JOKE] = "Agitar antes de usar";
		SPANISH_WORDS[SPACESHIP_UPGRADE_5] = "Abrir agujero rosa";
		SPANISH_WORDS[SPACESHIP_UPGRADE_5_JOKE] = "Atravesarlo puede producir un desgarro en el espacio-tiempo";
		SPANISH_WORDS[SPACESHIP_UPGRADE_6] = "Encuentros en la Tercera Fase";
		SPANISH_WORDS[SPACESHIP_UPGRADE_6_JOKE] = "Son un poco idiotas, pero tendremos que aprender a quererlos - Firmado : Los aliens";
		SPANISH_WORDS[SPACESHIP_UPGRADE_7] = "Imperio Galáctico";
		SPANISH_WORDS[SPACESHIP_UPGRADE_7_JOKE] = "Que el amor te acompañe";
		...
		CATALAN_WORDS[FACTORY_UPGRADE_2] = "Producció en cadena";
		CATALAN_WORDS[FACTORY_UPGRADE_2_JOKE] = "Literalment";
		CATALAN_WORDS[FACTORY_UPGRADE_3] = "Mans petites";
		CATALAN_WORDS[FACTORY_UPGRADE_3_JOKE] = "Petits treballadors que gestionen fins i tot els detalls més petits";
		CATALAN_WORDS[FACTORY_UPGRADE_4] = "Màquines de vapor";
		CATALAN_WORDS[FACTORY_UPGRADE_4_JOKE] = "Augmenta la producció a costa d’uns pocs accidents";
		CATALAN_WORDS[FACTORY_UPGRADE_5] = "Simulacre d'incendi";
		CATALAN_WORDS[FACTORY_UPGRADE_5_JOKE] = "Acomiadarem els empleats morts";
		CATALAN_WORDS[FACTORY_UPGRADE_6] = "Micos esquirols";
		CATALAN_WORDS[FACTORY_UPGRADE_6_JOKE] = "Consumeixen molts plàtans, però no reivindiquen cap dret";
		CATALAN_WORDS[FACTORY_UPGRADE_7] = "Rius àcids";
		CATALAN_WORDS[FACTORY_UPGRADE_7_JOKE] = "Pescar peixos amb les mans és senzill quan suren boca cap amunt";
		...
		CATALAN_WORDS[LABORATORY_UPGRADE_3] = "Partícula fonamental de l’amor";
		CATALAN_WORDS[LABORATORY_UPGRADE_3_JOKE] = "El model és perfecte, però la realitat no s’hi ajusta correctament";
		...
		CATALAN_WORDS[LABORATORY_UPGRADE_5] = "Amor quàntic";
		CATALAN_WORDS[LABORATORY_UPGRADE_5_JOKE] = "Cors entrellaçats";
		CATALAN_WORDS[LABORATORY_UPGRADE_6] = "Robo-criada";
		CATALAN_WORDS[LABORATORY_UPGRADE_6_JOKE] = "Els científics estan encantats";
		CATALAN_WORDS[LABORATORY_UPGRADE_7] = "LoveOS";
		CATALAN_WORDS[LABORATORY_UPGRADE_7_JOKE] = "La resposta a la teua pregunta és 69";
		...
		CATALAN_WORDS[SHOP_UPGRADE_2] = "Amor d’un sol ús";
		CATALAN_WORDS[SHOP_UPGRADE_2_JOKE] = "Munts de brossa fins on arriba la vista";
		CATALAN_WORDS[SHOP_UPGRADE_3] = "Anuncis publicitaris invasius";
		CATALAN_WORDS[SHOP_UPGRADE_3_JOKE] = "Gaudeix d’increïbles anuncis mentre somnies";
		CATALAN_WORDS[SHOP_UPGRADE_4] = "Hamor*";
		CATALAN_WORDS[SHOP_UPGRADE_4_JOKE] = "Gairebé* com l’original";
		CATALAN_WORDS[SHOP_UPGRADE_5] = "Amor novíssim";
		CATALAN_WORDS[SHOP_UPGRADE_5_JOKE] = "Totalment diferent de l'anterior";
		CATALAN_WORDS[SHOP_UPGRADE_6] = "Inventar una nova festivitat";
		CATALAN_WORDS[SHOP_UPGRADE_6_JOKE] = "Consumiu més, malparits";
		CATALAN_WORDS[SHOP_UPGRADE_7] = "LoveCard®";
		CATALAN_WORDS[SHOP_UPGRADE_7_JOKE] = "Hi ha coses que l’amor no pot comprar, per a tota la resta: LoveCard®";
		...
		CATALAN_WORDS[SPACESHIP_UPGRADE_2] = "Escombraries espacials";
		CATALAN_WORDS[SPACESHIP_UPGRADE_2_JOKE] = "Per més alt que les llances no desapareixeran";
		CATALAN_WORDS[SPACESHIP_UPGRADE_3] = "Estació Espacial Internacional";
		CATALAN_WORDS[SPACESHIP_UPGRADE_3_JOKE] = "La gravetat zero obre noves possibilitats, hem d’actualitzar el Llibre Sagrat de l’Amor";
		CATALAN_WORDS[SPACESHIP_UPGRADE_4] = "Doll còsmic";
		CATALAN_WORDS[SPACESHIP_UPGRADE_4_JOKE] = "Agitar abans d’usar";
		CATALAN_WORDS[SPACESHIP_UPGRADE_5] = "Obrir forat rosa";
		CATALAN_WORDS[SPACESHIP_UPGRADE_5_JOKE] = "Travessar-lo pot provocar un esvoranc en l’espaitemps";
		CATALAN_WORDS[SPACESHIP_UPGRADE_6] = "Troballes en la 3a Fase";
		CATALAN_WORDS[SPACESHIP_UPGRADE_6_JOKE] = "TSón un poc idiotes, però haurem d’aprendre a estimar-los – Signat: Els extraterrestres";
		CATALAN_WORDS[SPACESHIP_UPGRADE_7] = "Imperi Galàctic";
		CATALAN_WORDS[SPACESHIP_UPGRADE_7_JOKE] = "Que l’amor t’acompanye";
		...
		ITALIAN_WORDS[FACTORY_UPGRADE_2] = "La produzione a catena";
		ITALIAN_WORDS[FACTORY_UPGRADE_2_JOKE] = "Letteralmente";
		ITALIAN_WORDS[FACTORY_UPGRADE_3] = "Mani piccole";
		ITALIAN_WORDS[FACTORY_UPGRADE_3_JOKE] = "Piccoli lavoratori per prestare attenzione anche ai piccoli dettagli";
		ITALIAN_WORDS[FACTORY_UPGRADE_4] = "Macchine a vapore";
		ITALIAN_WORDS[FACTORY_UPGRADE_4_JOKE] = "Aumenta la produzione a scapito di alcuni incidente";
		ITALIAN_WORDS[FACTORY_UPGRADE_5] = "Esercitazione antincendio";
		ITALIAN_WORDS[FACTORY_UPGRADE_5_JOKE] = "I dependenti morti saranno licenziati";
		ITALIAN_WORDS[FACTORY_UPGRADE_6] = "Scimmie crumiri";
		ITALIAN_WORDS[FACTORY_UPGRADE_6_JOKE] = "Chiedono tante banane, ma non pretendono nessun diritto";
		ITALIAN_WORDS[FACTORY_UPGRADE_7] = "Fiumi acidi";
		ITALIAN_WORDS[FACTORY_UPGRADE_7_JOKE] = "A cacica di pesce con le mani è facile quando il pesce galleggia";
		...
		ITALIAN_WORDS[LABORATORY_UPGRADE_3] = "Particella fondamentale dell'amore";
		ITALIAN_WORDS[LABORATORY_UPGRADE_3_JOKE] = "Il modello è perfetto, ma la realtà non si adatta a lui";
		...
		ITALIAN_WORDS[LABORATORY_UPGRADE_5] = "Amore quantistico";
		ITALIAN_WORDS[LABORATORY_UPGRADE_5_JOKE] = "Cuori intrecciati";
		ITALIAN_WORDS[LABORATORY_UPGRADE_6] = "Robo-servitrice";
		ITALIAN_WORDS[LABORATORY_UPGRADE_6_JOKE] = "Gli scienziati sono contenti";
		ITALIAN_WORDS[LABORATORY_UPGRADE_7] = "LoveOS";
		ITALIAN_WORDS[LABORATORY_UPGRADE_7_JOKE] = "La risposta alla tua domanda è 69";
		...
		ITALIAN_WORDS[SHOP_UPGRADE_2] = "Amore d’usa e getta";
		ITALIAN_WORDS[SHOP_UPGRADE_2_JOKE] = "Montagne d’immondizia fin dove arriva lo sguardo";
		ITALIAN_WORDS[SHOP_UPGRADE_3] = "Annunci invadenti";
		ITALIAN_WORDS[SHOP_UPGRADE_3_JOKE] = "Godati annunci incredibili mentre sogni";
		ITALIAN_WORDS[SHOP_UPGRADE_4] = "Hamore*";
		ITALIAN_WORDS[SHOP_UPGRADE_4_JOKE] = "Quasi* come il originale";
		ITALIAN_WORDS[SHOP_UPGRADE_5] = "Nuovo amore";
		ITALIAN_WORDS[SHOP_UPGRADE_5_JOKE] = "Totalmente diverso dal precedente";
		ITALIAN_WORDS[SHOP_UPGRADE_6] = "Inventare nuove festività";
		ITALIAN_WORDS[SHOP_UPGRADE_6_JOKE] = "Consumate di più, bastardi";
		ITALIAN_WORDS[SHOP_UPGRADE_7] = "LoveCard®";
		ITALIAN_WORDS[SHOP_UPGRADE_7_JOKE] = "Ci sono cose che l’amore non può comprare, per tutto il resto: LoveCard®";
		...
		ITALIAN_WORDS[SPACESHIP_UPGRADE_2] = "Spazzatura spaziale";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_2_JOKE] = "Anche se la butti lontano, non scomparirà";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_3] = "Stazione Spaziale Internazionale";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_3_JOKE] = "La gravità zero apre nuove possibilità, bisogna aggiornare il Libro Sacro dell’Amore";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_4] = "Getto cósmico";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_4_JOKE] = "Agitare prima dell’uso";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_5] = "Aprire buco rosa";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_5_JOKE] = "Attravesarlo può causare uno strappo nello spazio-tempo";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_6] = "Incontri ravvicinati del terzo tipo";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_6_JOKE] = "Sono un po’ scemi, ma dovremo imparare a volergli bene – Firmato : Gli Alieni";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_7] = "Impero Galattico";
		ITALIAN_WORDS[SPACESHIP_UPGRADE_7_JOKE] = "Che l’amore sia con te";
		...
		FRENCH_WORDS[FACTORY_UPGRADE_2] = "Chaîne de production";
		FRENCH_WORDS[FACTORY_UPGRADE_2_JOKE] = "Littéralement";
		FRENCH_WORDS[FACTORY_UPGRADE_3] = "Les petites mains";
		FRENCH_WORDS[FACTORY_UPGRADE_3_JOKE] = "De petits travailleurs pour être attentif aux plus petits détails";
		FRENCH_WORDS[FACTORY_UPGRADE_4] = "Les machines à vapeur";
		FRENCH_WORDS[FACTORY_UPGRADE_4_JOKE] = "Augmentent la production aux dépends de quelques accidents";
		FRENCH_WORDS[FACTORY_UPGRADE_5] = "Exercice d'incendie";
		FRENCH_WORDS[FACTORY_UPGRADE_5_JOKE] = "Les employés morts seront virés";
		FRENCH_WORDS[FACTORY_UPGRADE_6] = "Les singes lèche-bottes";
		FRENCH_WORDS[FACTORY_UPGRADE_6_JOKE] = "Ils mangent beaucoup de bananes, mais en contrepartie ils ne réclament aucun droit";
		FRENCH_WORDS[FACTORY_UPGRADE_7] = "Les rivières acides";
		FRENCH_WORDS[FACTORY_UPGRADE_7_JOKE] = "C’est facile de pêcher des poissons à mains nues quand ils flottent la bouche ouverte";
		...
		FRENCH_WORDS[LABORATORY_UPGRADE_3] = "La particule fondamentale de l'amour";
		FRENCH_WORDS[LABORATORY_UPGRADE_3_JOKE] = "Le modèle est parfait, mais la réalité ne lui va pas si bien";
		...
		FRENCH_WORDS[LABORATORY_UPGRADE_5] = "L’amour quantique";
		FRENCH_WORDS[LABORATORY_UPGRADE_5_JOKE] = "Des cœurs entrelacés";
		FRENCH_WORDS[LABORATORY_UPGRADE_6] = "Le robo-domestique";
		FRENCH_WORDS[LABORATORY_UPGRADE_6_JOKE] = "Les scientifiques en sont très content";
		FRENCH_WORDS[LABORATORY_UPGRADE_7] = "LoveOS";
		FRENCH_WORDS[LABORATORY_UPGRADE_7_JOKE] = "La réponse à ta question est '69'";
		...
		FRENCH_WORDS[SHOP_UPGRADE_2] = "Amour jetable";
		FRENCH_WORDS[SHOP_UPGRADE_2_JOKE] = "Des montagnes de poubelles à perte de vue";
		FRENCH_WORDS[SHOP_UPGRADE_3] = "Les publicités envahissantes";
		FRENCH_WORDS[SHOP_UPGRADE_3_JOKE] = "Profite d’incroyables publicités pendant que tu dors";
		FRENCH_WORDS[SHOP_UPGRADE_4] = "Hamour*";
		FRENCH_WORDS[SHOP_UPGRADE_4_JOKE] = "Presque* comme l'original";
		FRENCH_WORDS[SHOP_UPGRADE_5] = "Nouveau amour";
		FRENCH_WORDS[SHOP_UPGRADE_5_JOKE] = "Tout à fait différent du précédent";
		FRENCH_WORDS[SHOP_UPGRADE_6] = "Inventer de nouvelles fêtes";
		FRENCH_WORDS[SHOP_UPGRADE_6_JOKE] = "Consomme encore plus, idiots";
		FRENCH_WORDS[SHOP_UPGRADE_7] = "LoveCard®";
		FRENCH_WORDS[SHOP_UPGRADE_7_JOKE] = "Il y a des choses que l'amour n'achète pas, pour le reste il y a : LoveCard®";
		...
		FRENCH_WORDS[SPACESHIP_UPGRADE_2] = "La poubelle spatiale";
		FRENCH_WORDS[SPACESHIP_UPGRADE_2_JOKE] = "Même si tu la lances très loin, elle ne va pas disparaître";
		FRENCH_WORDS[SPACESHIP_UPGRADE_3] = "Station Spatiale Internationale";
		FRENCH_WORDS[SPACESHIP_UPGRADE_3_JOKE] = "La gravité zéro nous ouvre de nouvelles possibilités, on doit actualiser le Livre Sacré de l'Amour";
		FRENCH_WORDS[SPACESHIP_UPGRADE_4] = "Le jet cosmique";
		FRENCH_WORDS[SPACESHIP_UPGRADE_4_JOKE] = "Agiter avant emploi";
		FRENCH_WORDS[SPACESHIP_UPGRADE_5] = "Ouvrir le trou rose";
		FRENCH_WORDS[SPACESHIP_UPGRADE_5_JOKE] = "Le traverser peut causer un déchirement dans l'espace-temps";
		FRENCH_WORDS[SPACESHIP_UPGRADE_6] = "Rencontre du troisième type";
		FRENCH_WORDS[SPACESHIP_UPGRADE_6_JOKE] = "Ils sont un peu bêtes, mais nous devrons apprendre à les aimer – Signer : Les Aliens";
		FRENCH_WORDS[SPACESHIP_UPGRADE_7] = "L’Empire Galactique";
		FRENCH_WORDS[SPACESHIP_UPGRADE_7_JOKE] = "Que l'amour t'accompagne";
		...
		ROMANIAN_WORDS[FACTORY_UPGRADE_2] = "Producție lanț";
		ROMANIAN_WORDS[FACTORY_UPGRADE_2_JOKE] = "Literalmente";
		ROMANIAN_WORDS[FACTORY_UPGRADE_3] = "Mâini mici";
		ROMANIAN_WORDS[FACTORY_UPGRADE_3_JOKE] = "Mici muncitori pentru a fi atent si la cele mai mici detalii";
		ROMANIAN_WORDS[FACTORY_UPGRADE_4] = "Motor cu aburi";
		ROMANIAN_WORDS[FACTORY_UPGRADE_4_JOKE] = "Cresc producția la costul puținor accidente";
		ROMANIAN_WORDS[FACTORY_UPGRADE_5] = "Exercițiu de incendiu";
		ROMANIAN_WORDS[FACTORY_UPGRADE_5_JOKE] = "Muncitorii morți vor fi concediați";
		ROMANIAN_WORDS[FACTORY_UPGRADE_6] = "Maimuțe ticăloase";
		ROMANIAN_WORDS[FACTORY_UPGRADE_6_JOKE] = "Consumă multe banane, dar nu își cer niciun drept";
		ROMANIAN_WORDS[FACTORY_UPGRADE_7] = "Râuri acide";
		ROMANIAN_WORDS[FACTORY_UPGRADE_7_JOKE] = "A vâna pești cu mâinile e ușor când plutesc cu fața în sus";
		...
		ROMANIAN_WORDS[LABORATORY_UPGRADE_3] = "Particula fundamentală a dragostei";
		ROMANIAN_WORDS[LABORATORY_UPGRADE_3_JOKE] = "Modelul este perfect, dar realitatea nu prea se potrivește bine cu el";
		...
		ROMANIAN_WORDS[LABORATORY_UPGRADE_5] = "Dragoste cuantică";
		ROMANIAN_WORDS[LABORATORY_UPGRADE_5_JOKE] = "Inimi împletite";
		ROMANIAN_WORDS[LABORATORY_UPGRADE_6] = "Furt-servitoare";
		ROMANIAN_WORDS[LABORATORY_UPGRADE_6_JOKE] = "Oamenii de știință sunt încântați";
		ROMANIAN_WORDS[LABORATORY_UPGRADE_7] = "LoveOS";
		ROMANIAN_WORDS[LABORATORY_UPGRADE_7_JOKE] = "Raspunsul la întrebarea ta este 69";
		...
		ROMANIAN_WORDS[SHOP_UPGRADE_2] = "Dragoste de unică folosință";
		ROMANIAN_WORDS[SHOP_UPGRADE_2_JOKE] = "Munți de gunoi până unde cuprinzi cu vederea";
		ROMANIAN_WORDS[SHOP_UPGRADE_3] = "Anunțuri invasive";
		ROMANIAN_WORDS[SHOP_UPGRADE_3_JOKE] = "Bucurăte de anunțuri incredibile în timp ce visezi";
		ROMANIAN_WORDS[SHOP_UPGRADE_4] = "Dragosteh*";
		ROMANIAN_WORDS[SHOP_UPGRADE_4_JOKE] = "Aproape* ca și originalul";
		ROMANIAN_WORDS[SHOP_UPGRADE_5] = "Dragoste nou";
		ROMANIAN_WORDS[SHOP_UPGRADE_5_JOKE] = "Total diferit de cel anterior";
		ROMANIAN_WORDS[SHOP_UPGRADE_6] = "A inventa o nouă festivitate";
		ROMANIAN_WORDS[SHOP_UPGRADE_6_JOKE] = "Consumați mai mult, blestemaților";
		ROMANIAN_WORDS[SHOP_UPGRADE_7] = "LoveCard®";
		ROMANIAN_WORDS[SHOP_UPGRADE_7_JOKE] = "Sunt lucruri pe care dragostea nu le poate cumpăra, pentru orice altceva : LoveCard";
		...
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_2] = "Gunoi spațial";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_2_JOKE] = "Oricât de înalt ai aruncao nu o să dispară";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_3] = "Stația Spațială Internațională";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_3_JOKE] = "Gravitația zero deschide noi posibilități , trebuie să actualizezi întreaga Cartea Sacra a Iubirii";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_4] = "Jet cosmic";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_4_JOKE] = "Scutura înainte de folosință";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_5] = "Deschide gaura roză";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_5_JOKE] = "Travesarea poate ocaziona o sfâșietură în dimensiune spațiu-timp";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_6] = "Întâlniri în a treia fază";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_6_JOKE] = "Sunt puțin idioți, dar va trebui să învățăm să-i iubim. Semnat : Extratereștri";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_7] = "Imperiu Galactic";
		ROMANIAN_WORDS[SPACESHIP_UPGRADE_7_JOKE] = "Dragostea sa fie cu tine";
		...
		GERMAN_WORDS[FACTORY_UPGRADE_2] = "Kettenproduktion";
		GERMAN_WORDS[FACTORY_UPGRADE_2_JOKE] = "Buchstäblich";
		GERMAN_WORDS[FACTORY_UPGRADE_3] = "Kleine hände";
		GERMAN_WORDS[FACTORY_UPGRADE_3_JOKE] = "Kleine arbeiter um auch die kleinsten details handzuhaben";
		GERMAN_WORDS[FACTORY_UPGRADE_4] = "Dampfmaschinen";
		GERMAN_WORDS[FACTORY_UPGRADE_4_JOKE] = "Erhöhte produktion zu lasten einiger weniger unfälle";
		GERMAN_WORDS[FACTORY_UPGRADE_5] = "Feuerübung";
		GERMAN_WORDS[FACTORY_UPGRADE_5_JOKE] = "Tote arbeiter werden gefeuert";
		GERMAN_WORDS[FACTORY_UPGRADE_6] = "Krusten-Affen";
		GERMAN_WORDS[FACTORY_UPGRADE_6_JOKE] = "Sie fordern viele bananen, aber fordern keine rechte";
		GERMAN_WORDS[FACTORY_UPGRADE_7] = "Ätzende flüsse";
		GERMAN_WORDS[FACTORY_UPGRADE_7_JOKE] = "Fische mit bloßen händen zu fangen ist einfach, wenn sie mit dem gesicht nach oben fließen";
		...
		GERMAN_WORDS[LABORATORY_UPGRADE_3] = "Fundamentalpartikel der liebe";
		GERMAN_WORDS[LABORATORY_UPGRADE_3_JOKE] = "Das modell ist perfekt, aber die realität passt nicht ganz rein";
		...
		GERMAN_WORDS[LABORATORY_UPGRADE_5] = "Quantum-liebe";
		GERMAN_WORDS[LABORATORY_UPGRADE_5_JOKE] = "Verwickelte herzen";
		GERMAN_WORDS[LABORATORY_UPGRADE_6] = "Robo-dienerin";
		GERMAN_WORDS[LABORATORY_UPGRADE_6_JOKE] = "Die wissenschaftler sind sehr erfreut";
		GERMAN_WORDS[LABORATORY_UPGRADE_7] = "LoveOS";
		GERMAN_WORDS[LABORATORY_UPGRADE_7_JOKE] = "Die antwort auf deine frage ist 69";
		...
		GERMAN_WORDS[SHOP_UPGRADE_2] = "Einwegliebe";
		GERMAN_WORDS[SHOP_UPGRADE_2_JOKE] = "Ein haufen müll soweit das auge reicht";
		GERMAN_WORDS[SHOP_UPGRADE_3] = "Invasive werbung";
		GERMAN_WORDS[SHOP_UPGRADE_3_JOKE] = "Genieße unglaubliche werbung, während du träumst";
		GERMAN_WORDS[SHOP_UPGRADE_4] = "Liebeh*";
		GERMAN_WORDS[SHOP_UPGRADE_4_JOKE] = "Fast* wie das original";
		GERMAN_WORDS[SHOP_UPGRADE_5] = "Neue liebe";
		GERMAN_WORDS[SHOP_UPGRADE_5_JOKE] = "Ganz anders als die vorherige";
		GERMAN_WORDS[SHOP_UPGRADE_6] = "Make up neuer festivitäten";
		GERMAN_WORDS[SHOP_UPGRADE_6_JOKE] = "Konsumiert mehr, ihr spinner";
		GERMAN_WORDS[SHOP_UPGRADE_7] = "LoveCard®";
		GERMAN_WORDS[SHOP_UPGRADE_7_JOKE] = "Es gibt dinge, die kann liebe nicht kaufen, für alles andere: LoveCard®";
		...
		GERMAN_WORDS[SPACESHIP_UPGRADE_2] = "Weltall-müll";
		GERMAN_WORDS[SPACESHIP_UPGRADE_2_JOKE] = "Obwohl du es ganz weit weg werfen kannst, verschwindet es nicht";
		GERMAN_WORDS[SPACESHIP_UPGRADE_3] = "International Space Station";
		GERMAN_WORDS[SPACESHIP_UPGRADE_3_JOKE] = "Schwerelosigkeit öffnet uns neue möglichkeiten, wir müssen das heilige buch der liebe aktualisieren";
		GERMAN_WORDS[SPACESHIP_UPGRADE_4] = "Kosmischer strahl";
		GERMAN_WORDS[SPACESHIP_UPGRADE_4_JOKE] = "Schütteln vor benutzung";
		GERMAN_WORDS[SPACESHIP_UPGRADE_5] = "Oben offenes pinkes loch";
		GERMAN_WORDS[SPACESHIP_UPGRADE_5_JOKE] = "Es zu kreuzen kann eine träne im raum-zeit-kontinuum erzeugen";
		GERMAN_WORDS[SPACESHIP_UPGRADE_6] = "Zusammenstoß mit der dritten art";
		GERMAN_WORDS[SPACESHIP_UPGRADE_6_JOKE] = "Sie sind ein wenig dumm, aber wir müssen lernen sie zu lieben – Gezeichnet: Die aliens";
		GERMAN_WORDS[SPACESHIP_UPGRADE_7] = "Galaktisches Imperium";
		GERMAN_WORDS[SPACESHIP_UPGRADE_7_JOKE] = "Möge die liebe mit dir sein";
		...
		RUSSIAN_WORDS[FACTORY_UPGRADE_2] = "Производственная цепочка";
		RUSSIAN_WORDS[FACTORY_UPGRADE_2_JOKE] = "Буквально";
		RUSSIAN_WORDS[FACTORY_UPGRADE_3] = "Маленькие руки";
		RUSSIAN_WORDS[FACTORY_UPGRADE_3_JOKE] = "Маленькие рабочие чтобы обратить внимание на маленький детали";
		RUSSIAN_WORDS[FACTORY_UPGRADE_4] = "Паровые машины";
		RUSSIAN_WORDS[FACTORY_UPGRADE_4_JOKE] = "Увеличивает производство за счет нескольких аварий";
		RUSSIAN_WORDS[FACTORY_UPGRADE_5] = "Противопожарный инструктаж";
		RUSSIAN_WORDS[FACTORY_UPGRADE_5_JOKE] = "Мертвые работники будут уволены";
		RUSSIAN_WORDS[FACTORY_UPGRADE_6] = "Штрейкбре́хер шимпанзе";
		RUSSIAN_WORDS[FACTORY_UPGRADE_6_JOKE] = "Потребляют много банан, но не требуют никаких прав";
		RUSSIAN_WORDS[FACTORY_UPGRADE_7] = "Кислотные Реки";
		RUSSIAN_WORDS[FACTORY_UPGRADE_7_JOKE] = "Ловыт рыбы с голыми руками легко, когда они плавают лицом вверх";
		...
		RUSSIAN_WORDS[LABORATORY_UPGRADE_3] = "Фундаментальная частица любви";
		RUSSIAN_WORDS[LABORATORY_UPGRADE_3_JOKE] = "Модель идеально, но реальность не вполне вписывается в ней";
		...
		RUSSIAN_WORDS[LABORATORY_UPGRADE_5] = "Квантовая любовь";
		RUSSIAN_WORDS[LABORATORY_UPGRADE_5_JOKE] = "Запутанные сердца";
		RUSSIAN_WORDS[LABORATORY_UPGRADE_6] = "Робо-слуга";
		RUSSIAN_WORDS[LABORATORY_UPGRADE_6_JOKE] = "Ученые очень довольны";
		RUSSIAN_WORDS[LABORATORY_UPGRADE_7] = "LoveOS";
		RUSSIAN_WORDS[LABORATORY_UPGRADE_7_JOKE] = "Ответ на ваш вопрос 69";
		...
		RUSSIAN_WORDS[SHOP_UPGRADE_2] = "Одноразовая любовь";
		RUSSIAN_WORDS[SHOP_UPGRADE_2_JOKE] = "Кучи мусора, насколько глаз может видеть";
		RUSSIAN_WORDS[SHOP_UPGRADE_3] = "Инвазивные рекламе";
		RUSSIAN_WORDS[SHOP_UPGRADE_3_JOKE] = "Наслаждайтесь невероятные реклами в то время как вы мечтаете";
		RUSSIAN_WORDS[SHOP_UPGRADE_4] = "Любовь*";
		RUSSIAN_WORDS[SHOP_UPGRADE_4_JOKE] = "Почти* как оригинал";
		RUSSIAN_WORDS[SHOP_UPGRADE_5] = "Новый любовь";
		RUSSIAN_WORDS[SHOP_UPGRADE_5_JOKE] = "Полностью отличается от предыдущего";
		RUSSIAN_WORDS[SHOP_UPGRADE_6] = "Изобретать новый праздник";
		RUSSIAN_WORDS[SHOP_UPGRADE_6_JOKE] = "Потреблять больше, прокляты";
		RUSSIAN_WORDS[SHOP_UPGRADE_7] = "LoveCard®";
		RUSSIAN_WORDS[SHOP_UPGRADE_7_JOKE] = "Есть вещи, которые любовь не можете купить, для всего остального: LoveCard®";
		...
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_2] = "Космический мусор";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_2_JOKE] = "Независимо от того, как высоко вы броситe, это не исчезнет";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_3] = "Международная космическая станция";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_3_JOKE] = "Невесомост открывает новые возможности, мы должны обновить Священную Книгу Любви";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_4] = "Космическая струя";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_4_JOKE] = "Перед употреблением взбалтывать";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_5] = "Открыть розовый дыра";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_5_JOKE] = "Крест он может вызвать слезу в пространстве-времени";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_6] = "Близкие контакты 3-ей фазе";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_6_JOKE] = "Они немного глупи, но мы должны научиться любить их - Подписано: Иностранцы";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_7] = "Галактическая Империя";
		RUSSIAN_WORDS[SPACESHIP_UPGRADE_7_JOKE] = "Пусть любовь будет с вами";
